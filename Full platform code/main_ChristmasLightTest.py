        ...
        if (data[0:5] == b'$PUBX'):
            ...
            if latitude != 0 or longitude != 0:
                ...
                if lat < 0 or lon < 0:
                    ...
                    lat = 0
                    lon = 0
                    print ("Outside of the research area")
                else:
                    pycom.rgbled(0x2274D6) #blue
                    print ("Latitude "+ str(lat) + ', longtitude ' + str(lon))
            else:
                pycom.rgbled(0xD62274) # pink
                time.sleep(1)
                pycom.rgbled(0xD62274) # pink
                lat = 0
                lon = 0
...
#sending with lora
send_blob()
pycom.rgbled(0xD67422) #orange
GPS_off(gps)
time.sleep(2)
machine.deepsleep(180)
